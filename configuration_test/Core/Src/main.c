...
/**
  ******************************************************************************
  * @file           : main.c
  * @brief          : Main program body for now only containing configuration code.
  * The MY SETUP CALCULATIONS below show more on my process.
  * @note			: PA5 was double defined and given to SPI1_SCK
  ******************************************************************************
  * @attention
  *
...
*Treated as master
*Debug------------------------------------------------------------------------
*I turned on SWD for use with STLink as an addition.
*/
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOB, GPIO_PIN_10|SPI1_CS_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : PB10 SPI1_CS_Pin */
  GPIO_InitStruct.Pin = GPIO_PIN_10|SPI1_CS_Pin;
